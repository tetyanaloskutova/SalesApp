# Generated by Django 2.0.4 on 2018-04-15 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competitors', models.CharField(max_length=256, null=True)),
                ('partners', models.CharField(max_length=256, null=True)),
                ('CRM_id', models.CharField(max_length=256, null=True)),
                ('created_on', models.DateTimeField(default=django.utils.timezone.now, editable=False, null=True)),
                ('created_on_date', models.DateField(default=django.utils.timezone.now, null=True)),
                ('est_decision_date', models.DateField(default=django.utils.timezone.now, null=True)),
                ...
                ('actual_close_date', models.DateField(default=django.utils.timezone.now, null=True)),
                ...
                ('next_action', models.TextField(default='', null=True)),
                ('next_action_date', models.DateField(default=django.utils.timezone.now, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
